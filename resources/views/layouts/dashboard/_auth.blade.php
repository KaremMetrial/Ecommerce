...
<head>
    ...
    <title>Dashboard - @yield('title', 'Login')</title>
            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="index.html">
                        <img class="brand-logo" alt="admin logo" src="{{ asset('assets/dashboard') }}/app-assets/images/logo/logo.png">
                        <h3 class="brand-text">Metrial Ecommerce</h3>
                    </a>
                </li>
...
<footer class="footer fixed-bottom footer-dark navbar-border navbar-shadow">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <span class="float-md-left d-block d-md-inline-block">Copyright &copy; {{ date('Y') }}  Metrial Ecommerce All rights reserved. </span>
